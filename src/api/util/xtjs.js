(function() {
  ...
  var _XuntongJSBridge = {
   ...
   /**获取XuntongJSBridge对象*/ 
  var _getXuntongJSBridge=function()
   {  
	  if (!navigator.userAgent 
		  || (!/xuntong/i.test(navigator.userAgent.toLowerCase())  
			 && !/qing/i.test(navigator.userAgent.toLowerCase())) 																	         ) {
            var errmsg = "wrong lightapp context";
            throw new Error(errmsg);  
      } 
	  return _XuntongJSBridge;
   };
   window.XuntongJSBridge = _getXuntongJSBridge();
